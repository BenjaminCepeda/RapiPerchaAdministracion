 ...
 * @date 2020/12/06
 */
public class FrmPerfilAdministracion extends javax.swing.JFrame {

    /** Creates new form FrmPerfilAdministracion */
    public FrmPerfilAdministracion() {
        initComponents();
        cargarModelo();
    ...
    private void initComponents() {
        ...
        pnlContenedorLayout.setVerticalGroup(
            ...
            .addGroup(pnlContenedorLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(pnlPie, javax.swing.GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlContenedor, javax.swing.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPerfilAdministracion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPerfilAdministracion().setVisible(true);
            }
        });
    }
